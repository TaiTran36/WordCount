...
public class Test {
    static String regex_start = "^[[a-zA-Z]|(á|ạ|à|ả|ã|Á|Ạ|À|Ả|Ã|ă|ắ|ằ|ẳ|ặ|ẵ|Ă|Ắ|Ằ|Ẳ|Ặ|Ẵ|â|ấ|ầ|ẩ|ẫ|ậ|Â|Ấ|Ầ|Ẩ|Ẫ|Ậ|é|ẹ|è|ẻ|ẽ|É|Ẹ|È|Ẻ|Ẽ|ê|ề|ế|ể|ệ|ễ|Ê|Ế|Ề|Ể|Ệ|Ễ|đ|Đ|í|ì|ỉ|ị|ĩ|Í|Ĩ|Í|Ị|Ỉ|ó|ò|ỏ|ọ|õ|Ó|Ò|Ỏ|Õ|Ọ|ô|ố|ồ|ổ|ộ|Ô|Ố|Ồ|Ổ|Ộ|Ỗ|ơ|ớ|ờ|ợ|ỡ|ở|Ơ|Ớ|Ờ|Ở|Ợ|Ỡ|ư|ứ|ừ|ử|ự|ữ|Ư|Ứ|Ừ|Ử|Ữ|Ự|ý|ỳ|ỷ|ỹ|ỵ|Ý|Ỳ|Ỹ|Ỵ|Ỷ)]+.*";
